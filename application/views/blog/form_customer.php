      ...
      <div class="card-body">
        <form role="form" action="" method="POST">
          ...
          <div class="row">
            ...
            <div class="col-sm-10">
              <div class="form-group">
                <input type="text" class="form-control <?= form_error('nm_pengirim') != null ? "is-invalid" : "" ?>" name="nm_pengirim" id="nm_pengirim" placeholder="Isi Nama Pengirim" value="<?= set_value('nm_pengirim') != null ? set_value('nm_pengirim') : ($simpanDataPengirim == null ? '' :  $simpanDataPengirim['nm_pengirim']) ?>">
          ...
          <div class="row">
            ...
            <div class="col-sm-10">
              <div class="form-group">
                <input type="text" class="form-control <?= form_error('alamat_pengirim') != null ? "is-invalid" : "" ?>" name="alamat_pengirim" id="alamat_pengirim" placeholder="Isi Alamat Pengirim" value="<?= set_value('alamat_pengirim') != null ? set_value('alamat_pengirim') : ($simpanDataPengirim == null ? '' :  $simpanDataPengirim['alamat_pengirim']) ?>">
          ...
          <div class="row">
            ...
            <div class="col-sm-10">
              <div class="form-group">
                <input type="number" class="form-control <?= form_error('no_pengirim') != null ? "is-invalid" : "" ?>" name="no_pengirim" id="no_pengirim" placeholder="Isi Nomor HP Pengirim" value="<?= set_value('no_pengirim') != null ? set_value('no_pengirim') : ($simpanDataPengirim == null ? '' :  $simpanDataPengirim['no_HP_pengirim']) ?>">
          ...
          <div class="row">
            ...
            <div class="col-sm-10">
              <div class="form-group">
                <input type="text" class="form-control <?= form_error('ancer_pengirim') != null ? "is-invalid" : "" ?>" name="ancer_pengirim" id="ancer_pengirim" placeholder="Isi Ancer-Ancer Alamat Pengirim" value="<?= set_value('ancer_pengirim') != null ? set_value('ancer_pengirim') : ($simpanDataPengirim == null ? '' :  $simpanDataPengirim['ket_alamat_pengirim']) ?>">
          ...
          <div class="row">
            ...
            <div class="col-sm-10">
              <div class="form-group">
                <input type="text" class="form-control <?= form_error('bank') != null ? "is-invalid" : "" ?>" name="bank" id="bank" placeholder="Isi Nama Bank Jika Butuh Ditalangi" value="<?= set_value('bank') != null ? set_value('bank') : ($simpanDataPengirim == null ? '' :  $simpanDataPengirim['bank']) ?>">
                ...
                <input type="text" class="form-control <?= form_error('atas_nama') != null ? "is-invalid" : "" ?>" name="atas_nama" id="atas_nama" placeholder="Isi Nama Pada No. Rekening Jika Butuh Ditalangi" value="<?= set_value('atas_nama') != null ? set_value('atas_nama') : ($simpanDataPengirim == null ? '' :  $simpanDataPengirim['atas_nama']) ?>">
